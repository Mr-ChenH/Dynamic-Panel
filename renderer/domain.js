(function exposeNotchDomain(root, factory) {
  ...
  const homeLayoutDomain = (typeof require === 'function'
    ? require('./home-layout-domain')
    : globalThis.NotchHomeLayoutDomain);
  if (!homeLayoutDomain) throw new Error('NotchHomeLayoutDomain is unavailable');
  ...
  return {
    ...
    normalizeHomeLayout: homeLayoutDomain.normalizeHomeLayout,
    swapHomeLayoutSlots: homeLayoutDomain.swapHomeLayoutSlots,
    normalizeTodoCategoryNames: homeLayoutDomain.normalizeTodoCategoryNames,
    migrateTodoCategoryNames: homeLayoutDomain.migrateTodoCategoryNames,
    normalizeHomeWidgetSizes: homeLayoutDomain.normalizeHomeWidgetSizes,
    packHomeWidgetLayout: homeLayoutDomain.packHomeWidgetLayout,
    normalizeHiddenHomeModules: homeLayoutDomain.normalizeHiddenHomeModules,
    updateHomeModuleVisibility: homeLayoutDomain.updateHomeModuleVisibility,
    resolveHomeWidgetLayout: homeLayoutDomain.resolveHomeWidgetLayout,
    validateHomeWidgetLayout: homeLayoutDomain.validateHomeWidgetLayout,
    layoutVariantForPlacement: homeLayoutDomain.layoutVariantForPlacement,
    calculateAudioLevel,
