...
for (const file of ['main.js', 'main-services.js', 'platform.js', 'preload.js', 'launcher/domain.js', 'launcher/regex.js', 'launcher/application-actions.js', 'renderer/launcher-regex-worker.js', 'launcher/storage-schema.js', 'launcher/data-transfer.js', 'launcher/focus.js', 'launcher/paths.js', 'launcher/extension-runner.js', 'launcher/extension-schema.js', 'launcher/extension-host.js', 'launcher/service.js', 'renderer/launcher.js', 'renderer/settings.js', 'renderer/domain.js', 'renderer/effects.js', 'renderer/app.js', 'renderer/workspace.js', 'renderer/icon-motion.js', 'renderer/notification.js', 'build/afterPack.js', 'scripts/codex-notify.js', 'scripts/claude-notify.js', 'scripts/smoke-app.js']) {
