    ...
    setTimeout(async () => {
      try {
        ...
        const homeAudit=await contents.executeJavaScript(`(async()=>{
          ...
          return {saved,weather,weatherDetail,cleared,media,musicPanelStable,noImplicitHistory,markdownSafe,composerGrows,pickerOpened,pickerFits,clipImageExcluded,contextSelected,contextSent,contextFrozen,chatted,chatNoteSaved:Boolean(chatNoteSaved),chatNoteUndone,cancelled,recoverable:Boolean(recoverable),retryRecovered,readerEligibility,readerOpened,readerTodoNeedsSelection,readerFits,outlineMoved,readerFullCopied,readerCodeCopied,readerSelectionReady,readerSelectionCopied,readerNoteSaved,readerNoteUndone,readerTodoSource,readerTodoPreview,readerReturned,readerClosed,saveDisclosure,sessionSaved,sessionRenamed,sessionSearchWorks,sessionRestored,sessionPanelFits,chatFits,recoverDebug,clearChat,classicRemoved,fits};
        })()`);
        assert.equal(homeAudit.recoverable,true,JSON.stringify(homeAudit.recoverDebug));delete homeAudit.recoverDebug;
        assert.deepEqual(homeAudit,{saved:true,weather:true,weatherDetail:true,cleared:true,media:true,musicPanelStable:true,noImplicitHistory:true,markdownSafe:true,composerGrows:true,pickerOpened:true,pickerFits:true,clipImageExcluded:true,contextSelected:true,contextSent:true,contextFrozen:true,chatted:true,chatNoteSaved:true,chatNoteUndone:true,cancelled:true,recoverable:true,retryRecovered:true,readerEligibility:true,readerOpened:true,readerTodoNeedsSelection:true,readerFits:true,outlineMoved:true,readerFullCopied:true,readerCodeCopied:true,readerSelectionReady:true,readerSelectionCopied:true,readerNoteSaved:true,readerNoteUndone:true,readerTodoSource:true,readerTodoPreview:true,readerReturned:true,readerClosed:true,saveDisclosure:true,sessionSaved:true,sessionRenamed:true,sessionSearchWorks:true,sessionRestored:true,sessionPanelFits:true,chatFits:true,clearChat:true,classicRemoved:true,fits:true});
