  ...
  contents.once('did-finish-load', () => {
    ...
    setTimeout(async () => {
      try {
        ...
        await contents.executeJavaScript(`document.getElementById('home-chat-sessions').click()`);
        await new Promise(resolve=>setTimeout(resolve,80));
