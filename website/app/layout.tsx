...
const title = "Dynamic Panel — Mac 与 Windows 的贴顶工作台";
...
export const metadata: Metadata = {
  ...
  title,
  description,
  applicationName: "Dynamic Panel",
  keywords: ["Dynamic Panel", "macOS 刘海", "Mac 待办", "Windows 待办", "本地工作台", "Apple Silicon"],
  icons: { icon: [{ url: assetPath("/favicon.png"), type: "image/png" }], shortcut: assetPath("/favicon.png"), apple: assetPath("/favicon.png") },
  openGraph: {
    type: "website",
    locale: "zh_CN",
    siteName: "Dynamic Panel",
    title,
    description,
    images: [{ url: assetPath("/og.png"), width: 1200, height: 630, alt: "Dynamic Panel 官网分享封面" }],
  },
