...
| 电脑 | 下载文件 | 安装方式 |
| --- | --- | --- |
| Mac · Apple Silicon · macOS 13+ | `TO-DO-Panel-1.1.0-arm64.dmg` | 打开 DMG，将应用拖入「应用程序」 |
| Windows 10/11 · Intel / AMD 64 位（x64） | `TO-DO-Panel-1.1.0-windows-x64-setup.exe` | 双击 EXE，按安装向导完成安装 |
