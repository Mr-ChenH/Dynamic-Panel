...
**Goal:** Replace the current left-copy/right-image Hero with the approved full-screen photographic Mac composition, real expanded/collapsed Dynamic Panel interaction, and staged entrance animation.
